...
public class ArmorBarRenderer {
    ...
    public void render(MatrixStack matrices, PlayerEntity player) {
        ...
        int healthRow = MathHelper.ceil((maxHealth + absorptionHealth) / 20.0f);
        ...
        //Default
        if (maxArmorPoints > 0) {
            int stackCount = (maxArmorPoints - 1) / 20;
        ...
        //Thorns Check
        if (getConfig().getOptions().toggleThorns && thorns.level > 0 && maxArmorPoints > 0) {
